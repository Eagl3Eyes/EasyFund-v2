    ...
    <div className="container mx-auto px-4 py-12">
      <div className="mx-auto max-w-3xl">
        ...
        <div className="prose prose-gray mt-8 space-y-6 text-muted-foreground">
          ...
          <h2 className="text-2xl font-bold text-foreground !mt-12">What Makes Us Different</h2>
          <ul className="space-y-4">
            <li>
              <strong className="text-foreground">Verification System:</strong> Our layered
          ...
          <h2 className="text-2xl font-bold text-foreground !mt-12">Get in Touch</h2>
          <p>
