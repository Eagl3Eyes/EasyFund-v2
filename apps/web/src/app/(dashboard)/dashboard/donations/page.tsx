  ...
  return (
    <div className="p-6 lg:p-8">
      <div className="mb-8">
        ...
        <p className="mt-1 text-muted-foreground">Track your donation history</p>
      </div>

      <div className="mb-6 rounded-lg bg-primary/5 p-4">
        <p className="text-sm text-muted-foreground">Total Donated</p>
        <p className="text-2xl font-bold text-primary">${totalDonated.toLocaleString()}</p>
      </div>
      ...
      {isDataLoading ? (
        ...
        <div className="rounded-xl border bg-card p-12 text-center">
          ...
          <p className="mt-2 text-muted-foreground">Your donation history will appear here</p>
        </div>
      ) : (
