        ...
        <div className="mx-auto max-w-7xl px-4 pt-3 sm:px-6 lg:px-8">
          <nav className="flex h-14 items-center justify-between rounded-2xl border border-white/[0.08] bg-[#071324]/80 px-4 shadow-2xl backdrop-blur-xl sm:h-16 lg:px-6">
            ...
            <div className="hidden items-center gap-2.5 lg:flex">
              ...
              <a href="/dashboard/fundraiser/campaigns/new" className="rounded-xl bg-[#0ef695] px-5 py-2 text-[13px] font-bold text-[#060e1e] shadow-lg shadow-[#0ef695]/20 transition hover:-translate-y-0.5 hover:bg-[#38f9a8]">
                Start a Campaign
              </a>
            </div>
            ...
            >
              <div className="flex flex-col gap-1">
                ...
                <div className="mt-3 grid grid-cols-2 gap-2">
                  ...
                  <a href="/dashboard/fundraiser/campaigns/new" className="rounded-xl bg-[#0ef695] py-2.5 text-center text-sm font-bold text-[#060e1e]">Start Campaign</a>
                </div>
              </div>
            </motion.div>
          )}
            ...
            <div>
              ...
              <Reveal delay={0.18}>
                <div className="mt-8 flex flex-wrap gap-3">
                  <a href="/dashboard/fundraiser/campaigns/new" className="rounded-2xl bg-[#0ef695] px-6 py-3.5 text-sm font-bold text-[#060e1e] shadow-lg shadow-[#0ef695]/20 transition hover:-translate-y-0.5 hover:bg-[#38f9a8]">
                    Start a Campaign
                  </a>
      ...
      <footer className="relative z-20 border-t border-white/[0.06] bg-[#040b16] py-12 sm:py-14">
        <div className="mx-auto max-w-7xl px-5 sm:px-6 lg:px-12">
          <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-5">
            ...
            {/* Columns */}
            {[
              { title: 'Platform', links: [['Explore', '/explore'], ['How It Works', '/how-it-works'], ['Create Campaign', '/dashboard/fundraiser/campaigns/new']] },
